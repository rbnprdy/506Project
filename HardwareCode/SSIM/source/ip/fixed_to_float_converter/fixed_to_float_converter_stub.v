...
// Command     : write_verilog -force -mode synth_stub -rename_top fixed_to_float_converter -prefix
//               fixed_to_float_converter_ fixed_to_float_stub.v
...
module fixed_to_float_converter(aclk, s_axis_a_tvalid, s_axis_a_tready, 
